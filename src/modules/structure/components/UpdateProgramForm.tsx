...
const UpdateProgramForm = ({ program, onSuccess, onCancel }: UpdateProgramFormProps) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      totalCredits: program.totalCredits as any,
      numberOfSemesters: program.numberOfSemesters as any,
  ...
  const onSubmit = async (data: ProgramFormValues) => {
    try {
      ...
      await programApi.updateProgram(program.id, data);
      toaster.create({
        title: 'Success',
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6" noValidate>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Input
          ...
          error={errors.totalCredits?.message as string}
          required
        />
        <Input
          ...
          error={errors.numberOfSemesters?.message as string}
          required
        />
