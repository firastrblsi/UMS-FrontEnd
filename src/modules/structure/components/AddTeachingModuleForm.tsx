...
interface AddTeachingModuleFormProps {
  onSuccess: () => void;
  onCancel: () => void;
}

export default function AddTeachingModuleForm({ onSuccess, onCancel }: AddTeachingModuleFormProps) {
  ...
  const onSubmit = async (data: any) => {
    try {
      setIsLoading(true);
      await teachingModuleApi.createTeachingModule(data);
